 ...
 * Uninstall handler.
 *
 * Default behavior is deliberately non-destructive. Only the explicit
 * File 20 `delete_on_uninstall` policy purges File-20-owned operational state.
 * Companion pages/content/tables/options are never deleted here.
 *
...
/* Stop File 20 scheduled work first. */
...
$file20_options = array(
	...
	'sabri_shell_activation_snapshot',
	'sabri_shell_activation_snapshot_legacy',
	'sabri_shell_flush_rewrite_rules',
	'sabri_shell_future_rewrite_version',
	'sabri_shell_navigation_cache_epoch',
	'sabri_shell_settings_row_version',
	'sabri_shell_plan_v4_audit',
	...
	'sabri_shell_plan_v4_recovery_lock',
	'sabri_shell_plan_v4_contract_health',
...
foreach ( $file20_options as $option_name ) {
	delete_option( $option_name );
}

/* Known File 20 transients. Locale/epoch-specific navigation transients expire
 * naturally and become unreachable once the cache epoch option is removed. */
foreach ( array(
	'sabri_shell_navigation_cache_v1',
	'sabri_shell_integration_cache',
	'sabri_shell_plan_v4_contract_health',
) as $transient_name ) {
	delete_transient( $transient_name );
}

/* File 20 owns only this welcome-dismissal user preference. */
if ( function_exists( 'delete_metadata' ) ) {
	delete_metadata( 'user', 0, 'sabri_shell_welcome_dismissed_at', '', true );
}
