...
$assert(strpos($main, 'Version: 1.4.8') !== false && strpos($main, "SABRI_SHELL_VERSION', '1.4.8") !== false, 'release identity 1.4.8');
...
$assert(strpos($main, 'FutureShellV5EighthHardening::register') !== false && strpos($eighth, "CONTRACT_VERSION = '1.0.8'") !== false, 'eighth corrective harmonization registered');
...
$assert(strpos($readme, 'Version: `1.4.8`') !== false && strpos($readmetxt, 'Stable tag: 1.4.8') !== false, 'release documentation identity 1.4.8');
...
echo 'Four-plan plus conditional/eighth harmonization assertions: ' . count($checks) . " passed\n";
