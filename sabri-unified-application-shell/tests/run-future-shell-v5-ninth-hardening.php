...
$p1 = strpos( $nav, "'source_priority'] = 1" ); $p2 = strpos( $nav, "'source_priority'] = 2" ); $p3 = strpos( $nav, "'source_priority'] = 3" ); $p4 = strpos( $nav, "'source_priority'] = 4" ); $p5 = strpos( $nav, "'source_priority'] = 5" );
...
foreach ( array( 'sabri_shell_plan_v4_audit', 'sabri_shell_plan_v4_snapshots', 'sabri_shell_future_v5', 'sabri_shell_future_lkg', 'sabri_shell_emergency_state', 'sabri_shell_settings_row_version' ) as $option ) { $assert( false !== strpos( $uninstall, $option ), 'explicit uninstall purges ' . $option ); }
