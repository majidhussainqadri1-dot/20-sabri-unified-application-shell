...
$a(strpos($main,'* Version: 1.4.15')!==false && strpos($main,"SABRI_SHELL_VERSION', '1.4.15")!==false,'release 1.4.15');
...
if($fail){fwrite(STDERR,"Second eighty-round consolidation FAIL: ".implode('; ',$fail)."\n");exit(1);} echo "Second fresh eighty-round consolidation under 1.4.15: route, ownership, diagnostics, REST privacy, concurrency and LKG controls PASS\n";
