...
$assert( false !== strpos( $main, '* Version: 1.4.14' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.14" ), 'current release 1.4.14 preserves sixth hardening' );
...
echo "Future Shell v5 sixth hardening preserved under 1.4.14 PASS\n";
