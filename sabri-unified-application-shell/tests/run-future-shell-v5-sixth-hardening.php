...
$assert( false !== strpos( $main, '* Version: 1.4.10' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.10" ), 'current release 1.4.10 preserves sixth hardening' );
...
echo "Future Shell v5 sixth hardening preserved under 1.4.10: historical File00/01/02/24 compatibility truth and native ownership PASS\n";
