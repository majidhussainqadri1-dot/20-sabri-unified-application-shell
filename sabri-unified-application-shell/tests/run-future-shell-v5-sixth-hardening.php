...
$assert( false !== strpos( $main, '* Version: 1.4.9' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.9" ), 'current release 1.4.9 preserves sixth hardening' );
...
echo "Future Shell v5 sixth hardening preserved under 1.4.9: File00/01/02/24 compatibility truth and native ownership PASS\n";
