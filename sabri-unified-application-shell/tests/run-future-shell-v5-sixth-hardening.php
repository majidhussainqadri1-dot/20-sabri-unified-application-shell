...
$assert( false !== strpos( $main, '* Version: 1.4.12' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.12" ), 'current release 1.4.12 preserves sixth hardening' );
...
echo "Future Shell v5 sixth hardening preserved under 1.4.12 PASS\n";
