...
$assert( false !== strpos( $main, '* Version: 1.4.17' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.17" ), 'current release 1.4.17 preserves sixth hardening' );
...
echo "Future Shell v5 sixth hardening preserved under 1.4.17 PASS\n";