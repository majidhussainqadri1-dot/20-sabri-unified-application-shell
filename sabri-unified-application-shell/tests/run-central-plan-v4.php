...
$assert(strpos($main, '* Version: 1.4.2') !== false, 'Plugin header must be 1.4.2.');
$assert(strpos($main, "define( 'SABRI_SHELL_VERSION', '1.4.2' )") !== false, 'Runtime version must be 1.4.2.');
