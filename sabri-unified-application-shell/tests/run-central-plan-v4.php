...
$assert(strpos($main, '* Version: 1.3.1') !== false, 'Plugin header must be 1.3.1.');
$assert(strpos($main, "define( 'SABRI_SHELL_VERSION', '1.3.1' )") !== false, 'Runtime version must be 1.3.1.');
