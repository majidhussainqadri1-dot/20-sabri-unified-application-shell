...
$assert(strpos($main, '* Version: 1.4.3') !== false, 'Plugin header must be 1.4.3.');
$assert(strpos($main, "define( 'SABRI_SHELL_VERSION', '1.4.3' )") !== false, 'Runtime version must be 1.4.3.');
