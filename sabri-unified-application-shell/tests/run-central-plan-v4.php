...
$assert(strpos($main, '* Version: 1.4.0') !== false, 'Plugin header must be 1.4.0.');
$assert(strpos($main, "define( 'SABRI_SHELL_VERSION', '1.4.0' )") !== false, 'Runtime version must be 1.4.0.');
