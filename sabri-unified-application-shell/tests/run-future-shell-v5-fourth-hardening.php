...
$assert( false !== strpos( $main, '* Version: 1.4.8' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.8" ), 'current release identity 1.4.8 preserves fourth hardening' );
...
echo "Future Shell v5 fourth hardening preserved under 1.4.8: historical companion contracts, public WebAuthn route and File24 states PASS\n";
