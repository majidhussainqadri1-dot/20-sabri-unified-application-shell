...
$assert( false !== strpos( $main, '* Version: 1.4.15' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.15" ), 'current release identity 1.4.15 preserves fourth hardening' );
...
echo "Future Shell v5 fourth hardening preserved under 1.4.15 PASS\n";
