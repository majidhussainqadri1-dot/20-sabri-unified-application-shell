...
$assert( false !== strpos( $main, '* Version: 1.4.14' ) && false !== strpos( $main, "SABRI_SHELL_VERSION', '1.4.14" ), 'current release identity 1.4.14 preserves fourth hardening' );
...
echo "Future Shell v5 fourth hardening preserved under 1.4.14 PASS\n";
