...
$assert( false !== strpos( $uninstall, "empty( \$settings['delete_on_uninstall'] )" ) && false !== strpos( $uninstall, 'sabri_shell_plan_v4_snapshots' ) && false !== strpos( $uninstall, 'sabri_shell_future_lkg' ), 'opt-in complete File20 uninstall cleanup' );
