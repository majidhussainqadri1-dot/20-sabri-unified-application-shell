...
$checks = array(
    ...
    'invalid ring persistence fails closed' => false !== strpos( $hard, "$ring    = 'disabled';" ) && false !== strpos( $hard, "$percent = 0;" ),
    ...
    'no foreign backend creation' => false === strpos( $php . $hard, 'CREATE TABLE') && false === strpos( $php . $hard, 'dbDelta('),
);
