...
$checks = array(
    'current release preserves 1.4.3 hardening' => false !== strpos( $main, '* Version: 1.4.7' ) && false !== strpos( $main, "define( 'SABRI_SHELL_VERSION', '1.4.7' );" ),
...
echo "Future Shell v5 third hardening preserved under 1.4.7: protected routes, overflow fail-closed, single PWA owner and historical third-pass boundaries PASS\n";
