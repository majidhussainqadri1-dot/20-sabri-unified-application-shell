...
$checks = array(
    'current release preserves 1.4.3 hardening' => false !== strpos( $main, '* Version: 1.4.6' ) && false !== strpos( $main, "define( 'SABRI_SHELL_VERSION', '1.4.6' );" ),
    ...
    'File01 third-pass boundary preserved' => false !== strpos( $third, 'bootstrap-registries-contracts-activation-shared-conventions' ) && false !== strpos( $third, 'consume-foundation-registry-no-shell-or-search-truth' ),
    'File02 third-pass historical boundary preserved' => false !== strpos( $third, 'credentials-passkeys-sessions-risk-recovery-account-completion' ) && false !== strpos( $third, 'modern-auth-1.3.0-candidate-staging-unaccepted' ),
...
echo "Future Shell v5 third ten-round hardening preserved under 1.4.6: protected routes, overflow fail-closed, single PWA owner and historical third-pass boundaries PASS\n";
