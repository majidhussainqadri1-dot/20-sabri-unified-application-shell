...
$checks = array(
    ...
    'latest File01 boundary' => false !== strpos( $third, 'bootstrap-registries-contracts-activation-shared-conventions' ) && false !== strpos( $third, 'consume-foundation-registry-no-shell-or-search-truth' ),
    'latest File02 boundary' => false !== strpos( $third, 'credentials-passkeys-sessions-risk-recovery-account-completion' ) && false !== strpos( $third, 'modern-auth-1.3.0-candidate-staging-unaccepted' ),
...
echo "Future Shell v5 third ten-round hardening: protected routes, overflow fail-closed, single PWA owner, latest contracts and release 1.4.3 PASS\n";
